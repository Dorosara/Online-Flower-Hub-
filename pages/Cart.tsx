...
export const Cart = () => {
  ...
  if (cart.length === 0) {
    return (
      <div className="max-w-7xl mx-auto px-4 py-16 sm:px-6 lg:px-8 text-center min-h-[50vh] flex flex-col items-center justify-center">
        <div className="bg-white/80 backdrop-blur-md p-10 rounded-2xl shadow-lg border border-pink-100 inline-block">
  ...
  return (
    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
      <h1 className="text-3xl font-serif font-bold text-gray-900 mb-8 drop-shadow-sm">Shopping Cart</h1>

      <div className="flex flex-col lg:flex-row gap-12">
        {/* Cart Items */}
        <div className="flex-1">
          <div className="bg-white/80 backdrop-blur-md rounded-2xl shadow-sm border border-pink-100 p-6">
                ...
                <div key={item.id} className="py-6 flex flex-col sm:flex-row items-start sm:items-center">
                  ...
                  <div className="ml-4 flex-1 flex flex-col sm:flex-row sm:justify-between w-full">
                    ...
                    <div className="mt-4 sm:mt-0 flex items-center justify-between sm:flex-col sm:items-end sm:justify-between">
                      <div className="flex items-center border border-gray-300 rounded-md bg-white/50">
                        <button 
                          onClick={() => updateQuantity(item.id, item.quantity - 1)}
                          className="p-1 hover:bg-white text-gray-600"
                      ...
                      <button
                        ...
                        className="text-sm font-medium text-red-600 hover:text-red-500 flex items-center mt-2 transition-colors"
                      >
        ...
        {/* Order Summary */}
        <div className="w-full lg:w-96 bg-white/85 backdrop-blur-md rounded-2xl p-6 h-fit border border-pink-100 shadow-lg">
          ...
          <Button onClick={() => navigate('/checkout')} className="w-full mt-6 shadow-md" size="lg">
